...
public class TrainingBean {
    ...
    public TrainingBean(Long idEntrainement, String dateEntrainement, String heureOuverture, String heureFermeture, int prixEntrainement, Boolean kidAutorise, Long idClub) {
